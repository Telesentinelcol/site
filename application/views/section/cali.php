...
<div class="content">
    ...
    <div class="row section" id="Cali1">
        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-6 text-cali">
            <h2 class="titulo-one">CALI</h2>
            <p class="texto-informativo">En la sucursal del cielo, mayor seguridad en hogares y negocios con TELESENTINEL</p>
        ...
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-6">
            <figure class="bg-cali"></figure>
        </div>
        <a href="javascript:scrollToCali2();">
            <div class="abajo"></div>
        </a>
    </div>
    <div class="row section" id="Cali2">
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-6 text-cali">
            <h2 class="titulo-one">EN CALI</h2>
        ...
        <a href="javascript:scrollToCali3();">
            <div class="abajo"></div>
        </a>
    </div>
    <script>
    ...
    <div class="row section" id="Cali3">
