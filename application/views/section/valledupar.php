...
<div class="content">
    ...
    <div class="row section" id="Valledupar1">
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 text-cali">
            <h2 class="titulo-one">VALLEDUPAR</h2>
            <p class="texto-informativo">Cuidamos lo que mas quiere, más seguridad y mayor protección</p>
        ...
        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
            <figure class="bg-valledupar"></figure>
        </div>
        <a href="javascript:scrollToValledupar2();">
            <div class="abajo"></div>
        </a>
    </div>
    <div class="row section" id="Valledupar2">
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-6 text-cali">
            <h2 class="titulo-one">EN VALLEDUPAR</h2>
        ...
        <a href="javascript:scrollToValledupar3();">
            <div class="abajo"></div>
        </a>
    </div>
    <script>
    ...
    <div class="row section" id="Valledupar3">
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 text-cali">
