...
<figure class="logotipo"></figure>
    <div class="row section" id="Medellin1">
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 text-cali">
            <h2 class="titulo-one">MEDELLÍN</h2>
            <p class="texto-informativo">Protegemos con un sistema de alarma, televideo y rastreo vehícular lo que usted más quiere</p>
        ...
        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
            <figure class="bg-medellin"></figure>
        </div>
        <a href="javascript:scrollToMedellin2();">
            <div class="abajo"></div>
        </a>
    </div>
    <div class="row section" id="Medellin2">
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-6 text-cali">
            <h2 class="titulo-one">EN MEDELLÍN</h2>
        ...
        <a href="javascript:scrollToMedellin3();">
            <div class="abajo"></div>
        </a>
    </div>
    <script>
    ...
    <div class="row section" id="Medellin3">
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 text-cali">
