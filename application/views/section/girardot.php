...
<div class="content">
    ...
    <div class="row section" id="Girardot1">
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 text-cali">
            <h2 class="titulo-one">GIRARDOT</h2>
        ...
        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
            <figure class="bg-girardot"></figure>
        </div>
        <a href="javascript:scrollToGirardot2();">
            <div class="abajo"></div>
        </a>
    </div>
    <div class="row section" id="Girardot2">
        ...
        <a href="javascript:scrollToGirardot3();">
            <div class="abajo"></div>
        </a>
    </div>
    <script>
    ...
    <div class="row section" id="Girardot3">
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 text-cali">
