...
<div class="content"><figure class="logotipo"></figure>
    <div class="row section" id="Villavicencio1">
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 text-cali">
            <h2 class="titulo-one">VILLAVICENCIO</h2>
            <p class="texto-informativo">La seguridad de su hogar o negocio es lo más importante para nosotros.</p>
        ...
        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
            <figure class="bg-villavicencio"></figure>
        </div>
        <a href="javascript:scrollToVillavicencio2();">
            <div class="abajo"></div>
        </a>
    </div>
    <div class="row section" id="Villavicencio2">
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-6 text-cali">
            <h2 class="titulo-one">EN VILLAVICENCIO</h2>
        ...
        <a href="javascript:scrollToVillavicencio3();">
            <div class="abajo"></div>
        </a>
    </div>
    <script>
    ...
    <div class="row section" id="Villavicencio3">
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 text-cali">
