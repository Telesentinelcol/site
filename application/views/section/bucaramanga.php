...
<div class="content">
    ...
    <div class="row section" id="Bucaramanga1">
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 text-cali">
            <h2 class="titulo-one">BUCARAMANGA</h2>
            <p class="texto-informativo">Estamos donde más nos necesita</p>
        ...
        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
            <figure class="bg-bucaramanga"></figure>
        </div>
        <a href="javascript:scrollToBucaramanga2();">
            <div class="abajo"></div>
        </a>
    </div>
    <div class="row section" id="Bucaramanga2">
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-6 text-cali">
            <h2 class="titulo-one">EN BUCARAMANGA</h2>
        ...
        <a href="javascript:scrollToBucaramanga3();">
            <div class="abajo"></div>
        </a>
    </div>
    <script>
    ...
    <div class="row section" id="Bucaramanga3">
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 text-cali">
